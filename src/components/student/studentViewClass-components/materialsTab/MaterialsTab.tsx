...
const MaterialsTab = () => {
    const { searchTerm, setSearchTerm, selectedCategory, setSelectedCategory, categories, sortBy, setSortBy, filteredMaterials, handleViewDetails, handleDownload, showDetailsModal, setShowDetailsModal, selectedMaterial } = useMaterialsTab();
    ...
    const getFileIcon = (type: string) => {
        switch (type) {
            ...
            default:
                return <FileText className={classes.fileIcon} style={{ color: "#6b7280" }} />
        }
    }
                            ...
                            <div className={classes.materialInfo}>
                                ...
                                <div className={classes.materialDetails}>
                                    ...
                                    <div className={classes.materialMeta}>
                                        ...
                                        <span className={classes.metaItem}><FileText size={12} /> {material.size}</span>
                                        <span className={classes.metaItem}>
                                            <Download size={12} />
